...
aws s3 cp . s3://de-on-youtubevikrant-raw-useast1-dev/youtube/raw_statistics_reference_data/ --recursive --exclude "*" --include "*.json"

# To copy all data files to its own location, following Hive-style patterns:
aws s3 cp CAvideos.csv s3://de-on-youtubevikrant-raw-useast1-dev/youtube/raw_statistics/region=ca/
aws s3 cp DEvideos.csv s3://de-on-youtubevikrant-raw-useast1-dev/youtube/raw_statistics/region=de/
...
aws s3 cp RUvideos.csv s3://de-on-youtubevikrant-raw-useast1-dev/youtube/raw_statistics/region=ru/
